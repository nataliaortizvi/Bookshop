    ...
    state: () => ({
        products: [
            ...
            },
            {
                ...
                author: 'Delia Owens',
                notLike: true,
                about: 'For years, rumors of the “Marsh Girl” haunted Barkley Cove, a quiet fishing village. Kya Clark is barefoot and wild; unfit for polite society. So in late 1969, when the popular Chase Andrews is found dead, locals immediately suspect her.',
                price: 17.25,
                category: ['fiction', 'romance'],
                year: 2015,
                place: 'south america',
                image: '/images/books/salvajeBook.jpg',
                stars: '⭐️⭐️⭐️⭐️',
            },
        ],
